...
Cadence suggestion: post 1 theme per week per platform = ~3 months of weekly content. Or front-load 4 in week 1 then weekly after.

---

## 1. Star sweet spot — `star-sweet-spot`

**Image:** `/api/social-card/star-sweet-spot`

### LinkedIn
Every owner I talk to wants a 5.0 rating. Five round stars, nothing under.
...
### Instagram
Customers don't trust 5.0 stars.
...
### X
Customers don't trust 5.0. They trust 4.6.

Northwestern research: conversion peaks between 4.2 and 4.7, then drops.

A 5.0 with 30 reviews converts WORSE than a 4.6 with 30 reviews. Same volume, fewer calls.

Stop chasing perfect.

---

## 2. Cost of a dormant profile — `cost-of-dormant-profile`

**Image:** `/api/social-card/cost-of-dormant-profile`
...
## 3. 90-day rule — `review-velocity-90-day`

**Image:** `/api/social-card/review-velocity-90-day`
...
## 4. AI recommendation vs Google rank — `ai-recommendation-vs-rank`

**Image:** `/api/social-card/ai-recommendation-vs-rank`
...
## 5. DIY tools vs done-for-you — `diy-vs-dfy`

**Image:** `/api/social-card/diy-vs-dfy`
...
Software gives you a tool. Done-for-you gives you the result. Cheap isn't cheaper if nobody runs it.

---

## 6. After-hours payback — `after-hours-payback`

**Image:** `/api/social-card/after-hours-payback`
...
## 7. AI search share — `ai-search-share`

**Image:** `/api/social-card/ai-search-share`
...
### X
1 in 4 local searches now happens on AI tools.
...
## 8. Software vs work — `software-vs-work`

**Image:** `/api/social-card/software-vs-work`

### LinkedIn
Owner pulls up the dashboard of the marketing tool they're paying for. They log in. Look at me. Sigh.
...
### Instagram
The marketing tool you haven't opened in 6 months isn't a tool anymore.
...
### X
That marketing tool you haven't opened in 6 months isn't a tool. It's a bill.
...
## 9. Reviews compound — `reviews-compound`

**Image:** `/api/social-card/reviews-compound`
...
## 10. Yelp ads trap — `trade-yelp-trap`

**Image:** `/api/social-card/trade-yelp-trap`

### LinkedIn
Most HVAC and plumbing owners have paid for Yelp ads at some point. The pitch is compelling — appear at the top, beat the competition.
...
## 11. Med spa math — `med-spa-math`

**Image:** `/api/social-card/med-spa-math`
...
### X
A first-time Botox client = $400 visit + ~$2,000/yr.

She picks you first. Last review is 8 months old. She backs out. Books next door.

One missed review = roughly four lost bookings. The math compounds.

---

## 12. Pet groomer trust — `groomer-trust`

**Image:** `/api/social-card/groomer-trust`
