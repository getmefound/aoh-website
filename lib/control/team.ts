...
export const AGENT_TEAM: AgentTeamMember[] = [
  ...
  },
  {
    ...
    responsibility:
      "Checks workflow proof, launch risk, secrets, unsubscribe behavior, duplicate sends, and cost exposure.",
    owns: ["launch QA", "security sweep", "DND/unsubscribe checks", "cost guardrails"],
    proof: ["no-go risks listed", "test cases passed", "secrets absent", "scaled send approved"],
    currentFocus: "No scaled campaign send until reply routing and email safety pass.",
    color: "rose",
  },
  {
    agent: "Sender",
