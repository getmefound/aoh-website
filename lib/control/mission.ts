...
export const SERVICES: ServiceWork[] = [
  {
    ...
    agents: ["Manager", "Profile Manager", "GHL Expert", "Sorter", "Systems Director", "Coach", "Scout"],
  ...
  },
  {
    ...
    agents: ["Profile Manager", "GHL Expert", "Coach", "Systems Director"],
  ...
  },
  {
    ...
    job: "Look active",
    outcome: "Fills stale social and website gaps with the 10-post, 5-blog launch special before Reach sends new attention.",
    agents: ["Scout", "Coach", "Editor", "Press", "Systems Director"],
    skills: ["presence-audit", "social-fill-pack", "blog-draft", "approval-workflow", "publish-proof"],
    activeClients: 0,
    openTasks: 4,
    blocked: 0,
  },
  {
    slug: "social-reach",
    name: "Social Reach",
    job: "Join conversations",
    outcome: "Finds relevant social conversations, drafts helpful replies, and keeps human approval in front of posting.",
    agents: ["Scout", "Sales Manager", "Coach", "Press", "Systems Director"],
    skills: ["community-watchlist", "conversation-scoring", "comment-drafting", "human-approval", "outcome-tracking"],
    activeClients: 0,
    openTasks: 5,
    blocked: 1,
  },
  ...
  },
  {
    ...
    agents: ["Press", "Coach", "Profile Manager"],
  ...
  },
  {
    ...
    agents: ["GHL Expert", "Editor", "Press", "Profile Manager", "Systems Director"],
...
export const AGENT_SKILLS: AgentSkillProfile[] = [
  ...
  },
  {
    ...
    skills: [
      ...
      "cheap-prefilter",
      "community-watchlist",
      "conversation-opportunity-scoring",
      "presence-gap-audit",
    ],
    serviceOwners: ["Reach", "Social Reach", "Presence Refresh", "Internal training"],
  ...
  },
  {
    ...
    skills: [
      ...
      "helpful-comment-drafting",
      "content-angle-selection",
    ],
    serviceOwners: ["All sales-led services", "Presence Refresh", "Social Reach", "Internal training"],
    sourceDocs: [
      "docs/AGENT_OPERATING_MODEL.md",
      "docs/REVIEW_AUTOMATION_AGENT_SKILLS.md",
  ...
  },
  {
    ...
    skills: ["social-publishing", "newsletter-publishing", "gbp-post-publishing", "publish-proof", "approval-queue", "social-fill-proof"],
    serviceOwners: ["Publishing", "Presence Refresh", "Social Reach"],
  },
  {
    agent: "Relay",
...
export const BOARD_TASKS: BoardTask[] = [
  ...
  },
  {
    ...
    status: "Assigned",
    priority: "P1",
    due: "Next product build",
    tags: ["presence-refresh", "social-fill", "blog", "reach-setup"],
    reviewChecks: [
  ...
  },
  {
    ...
    status: "Assigned",
    priority: "P1",
    due: "After Presence Refresh package",
    tags: ["social-reach", "community", "linkedin", "facebook", "human-approval"],
    reviewChecks: [
      "Build approved watchlist before any monitoring",
      "No auto-commenting, auto-liking, fake accounts, or mass scraping",
      "Score each opportunity for helpfulness, fit, and promotion risk",
      "Human approves/posts during v1",
      "Track replies, DMs, booked calls, and useful language for future Reach campaigns",
    ],
  },
  {
  ...
  },
  {
    ...
    status: "Assigned",
    priority: "P0",
    due: "After Profile Manager handoff rules",
