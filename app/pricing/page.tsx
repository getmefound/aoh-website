...
const products: ProductDetailData[] = [
  ...
  },
  {
    ...
    price: "$449",
    cadenceLabel: "/mo",
    setup: "$299 setup",`r`n    promoNote: "First month $299 · code REACH150 · cancel anytime",`r`n    ctaLabel: "Start Reach",`r`n    ctaHref: "https://pay.aioutsourcehub.com/reach-plan",`r`n    secondaryCtaHref: BOOKING_HREF,
  ...
  },
  {
    ...
    price: "$399",
    cadenceLabel: "/mo",
    setup: "$299 setup",`r`n    promoNote: "First month $299 · code RELAY100 · cancel anytime",`r`n    ctaLabel: "Start Relay",`r`n    ctaHref: "https://pay.aioutsourcehub.com/checkout-relay-plan",`r`n    secondaryCtaHref: BOOKING_HREF,
