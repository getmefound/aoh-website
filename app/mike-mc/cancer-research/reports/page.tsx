...
export const metadata: Metadata = {
  title: "CBC Report Translator",
  description: "Paste report text for CBC to organize into a clearer read.",
...
export default function CbcReportsPage() {
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_top_left,#fbcfe8_0,#fff7ed_23rem,transparent_42rem),linear-gradient(135deg,#ecfeff_0%,#fff7ed_46%,#fdf2f8_100%)] text-slate-900">
      <div className="mx-auto w-full max-w-[92rem] px-4 py-6 md:px-8 md:py-10">
        <PageHeader eyebrow="Report Translator" title="Paste A Report" copy="A dedicated page for pathology, PET/CT, lab, and imaging text after personal identifiers are removed." />
        <CbcNav active="Reports" />
        <CancerResearchWorkbench view="reports" />
      </div>
    </main>
  );
}
