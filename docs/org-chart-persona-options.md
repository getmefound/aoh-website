# AOH Org Chart Persona Options

Use these as inspiration-label candidates only. Public figures are not affiliated with AOH and do not endorse the system.
...
| Role | Option 1 | Option 2 | Option 3 | Option 4 |
|---|---|---|---|---|
| Systems Director | Grace Hopper | Andy Grove | Margaret Hamilton | Gene Kim |
| GHL Expert | Paul Allen | Satya Nadella | John Carmack | Linus Torvalds |
...
| Booker | Mary Kay Ash | Barbara Corcoran | Sara Blakely | Daymond John |
| Engagement Scout | Gary Vaynerchuk | Guy Kawasaki | Mark Cuban | Alexis Ohanian |

## Client Success

| Role | Option 1 | Option 2 | Option 3 | Option 4 |
|---|---|---|---|---|
| Client Success Manager | Danny Meyer | Tony Hsieh | Horst Schulze | Ken Blanchard |
| Hub | Marc Benioff | Stewart Butterfield | Jim Barksdale | Meg Whitman |
| Reporter | Edward Tufte | Hans Rosling | Byron Wien | Nate Silver |
...
| Role | Option 1 | Option 2 | Option 3 | Option 4 |
|---|---|---|---|---|
| Editor | James Patterson | Stephen King | Dr. Seuss | Mark Twain |
| Press | Ted Turner | Stan Lee | P.T. Barnum | Rupert Murdoch |

## My Shortlist

This is the set I would try first if you want the chart to feel less random-celebrity and more "agent company with practical operators":
