...
| GBP access test | `docs/client-ops-ledger/gbp-client-access-and-update-test.md` | Shows how clients add AOH by email so Profile Manager can update profiles without password sharing. |
...
Manager owns the final brief. GHL Expert feeds campaign stats, Profile Manager feeds Google Business Profile access/update status, Sales Manager explains what the numbers mean, Scout watches market/news opportunities, and Systems Director watches cron/source failures.
